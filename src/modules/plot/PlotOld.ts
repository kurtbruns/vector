 ...
 */
export interface PlotOldConfig {
 ...
 * SVGs.
 */
export class PlotOld extends ResponsiveFrame {
     ...
     */
    constructor(container: Element, fn: (x: number) => number, config: PlotOldConfig) {

        // Default values 
        let defaultConfig: PlotOldConfig = {
